...
export default class InsurancePremiumReceiptVerification extends LightningElement {
    ...
    hideButtons=false
    label=''
    documentType='Insurance Premuim receipt'
    amount
    spinnerImage;
    ...
    async connectedCallback(){
        ...
        checkIfAlreadyUploaded({recordId: this.applicantId, documentType: this.documentType}).then((data)=>{
            if (data && data.Status__c==='Received') {
                ...
                this.label = 'Insurance Premium Receipt Uploaded with an Amount of '
