...
export default class HouseTaxReceiptVerification extends LightningElement {
    ...
    hideButtons=false
    label=''
    documentType='House Tax Receipt'
    amount
    spinnerImage;
    ...
    async connectedCallback(){
        ...
        checkIfAlreadyUploaded({recordId: this.applicantId, documentType: this.documentType}).then((data)=>{
            if(data && data.Status__c==='Received'){
                ...
                this.label = 'House Tax Receipt Uploaded with an Amount of '
