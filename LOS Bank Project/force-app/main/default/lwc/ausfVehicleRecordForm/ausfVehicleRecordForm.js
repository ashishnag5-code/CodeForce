...
export default class AusfVehicleRecordForm extends LightningElement {
  editAdress = false;
  ...
  async handleConfirmClick() {
    const result = await LightningConfirm.open({
        message: 'You have to provide RC copy with AU HPN before disbursement.',
        variant: 'headerless',
  ...
  handleSubmit(event) {
    ...
    fields.Collateral_Name__c = this.collateralObj.Collateral_Name__c;
    fields.Vehicle_Number__c = this.collateralObj.Vehicle_Number__c;
  ...
  handleSubmitForm() {
    ...
    this.collateralObj.Collateral_Type__c = "Vehicle";
