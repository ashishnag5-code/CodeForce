...
import diyCSS from '@salesforce/resourceUrl/LOSCommonStyles';
...
export default class LosOtpVerifyPage extends LightningElement {
    ...
    connectedCallback() {
        ...
        Promise.all([
        //loadStyle(this, diyIntlTelInputAssets + '/intlTelInputAssets/css/demo.css'),   
