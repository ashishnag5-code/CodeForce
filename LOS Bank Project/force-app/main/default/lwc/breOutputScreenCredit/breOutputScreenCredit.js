...
//import hasFiWaiverViewPermission from '@salesforce/customPermission/FiWaiverViewPermission';


export default class BreOutputScreenCredit extends LightningElement {
    ...
    @track isViewFIWaiver = false;
    @track isCreditMgr = false;
    ...
    /*
    get isViewFIWaiver() {
        return hasFiWaiverViewPermission;
    }
    */
        ...
        getBreResponse({
            ...
            .then(result => {
                ...
                if (result.blnSuccess == true) {
                     ...
                     this.showuwcriteria = result.hasShowCriteriaPermission;
                     this.isCreditMgr = result.isCreditManager;
                ...
                if (result.blnSuccess == true && result.blnBREError == false && result.breResponse != null) {
                    ...
                    /*
                    else if (this.isFromLoanTab == true) {
                        this.isEnableSchemeSelection = false;
                    }
                    else {
                        this.isEnableSchemeSelection = true;
                        ...
                        if (this.breResponse.message.responseStatus == 'SUCCESS') {
                            ...
                            if (this.breResponse.message.application.applicants.length > 0) {
                                ...
                                applicantsList.forEach(currentItem => {
                                    console.log('currentItem uwCriteriaArray', currentItem);
                            ...
                            if (this.breResponse.message.application.applicationDecision.systemDecision != 'DECLINE') {
                                ...
                                if(this.breResponse.message.application.applicants[0].cpvWaivedOff!=null && this.breResponse.message.application.applicants[0].cpvWaivedOff !=undefined)
                                    this.cpvWaivedOff = this.breResponse.message.application.applicants[0].cpvWaivedOff;
                                   ...
                                   // custGrade =  this.breResponse.message.application.applicants[0].customerGrade; 
                                    ...
                                    fiInitiationDetailslist.forEach(currentItem => {
                                        ...
                                        if(fiLocation ==''){
                                            ...
                                            if(this.isCreditMgr && this.cpvWaivedOff !='')
                                            this.isViewFIWaiver=true;
                                        }
                                        else{
                                        ...
                                        if(currItem["Applicant Type"]  == "CO_APPLICANT"){
                                            if (fiLocation == '') {
                                                fiLocation = 'Waived';
                                                if(this.isCreditMgr && this.cpvWaivedOff !='')
                                                this.isViewFIWaiver=true;
                                        ...
                                        if(currItem["Applicant Type"]  == "GUARANTOR"){
                                            if (fiLocation == '') {
                                                fiLocation = 'Waived';
                                                if(this.isCreditMgr && this.cpvWaivedOff !='')
                                                this.isViewFIWaiver=true;
                                    ...
                                    schemeDecisionList.forEach(currentItem => {
                                      ...
                                      //   this.notEligibleSchemes.push(Object.assign(schemeObject,{ 'isEligible': currentItem["Is Eligible"]}));
                                           ...
                                           // this.notEligibleSchemes.push(Object.assign(Wrapperobject,{ 'Other Eligible scheme': this.notEligibleSchemes}));
                                            ...
                                            if((currentItem["subjectivityMessages"]!=null) && currentItem["subjectivityMessages"]!=undefined)
                                                this.subjectivityMessagesArray.push({value:currentItem["subjectivityMessages"],key:currentItem["Scheme Name"]});
                                        }
                                        if ((currentItem["blnSchemeSelectedByRO"] == true)) {
                                         ...
                                         //   this.schemeDecisionArray.push(Object.assign(Wrapperobject,{ 'Eligible': currentItem["Is Eligible"]}));
                                           this.schemeMap.push({value:this.uwAuthority,key:"uwAuthority"});
                                            this.schemeMap.push({value:currentItem,key:currentItem["Scheme Name"]});
                                            if((currentItem["deviationsDetails"]!=null) || currentItem["deviationsDetails"]!=undefined)
                                                this.deviationsMap.push({value:currentItem["deviationsDetails"],key:currentItem["Scheme Name"]});
                                        ...
                                        if(this.subjectivityMessagesArray != undefined)
                                        this.schemeDecisionArray.push(Object.assign(Wrapperobject,{ 'subjectivityMessages':Array.from(this.subjectivityMessagesArray)}));
