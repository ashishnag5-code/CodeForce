...
export default class AusfPropertyRecordForm extends LightningElement {
  editAdress = false;
  ...
  async handleConfirmClick() {
    const result = await LightningConfirm.open({
        message: 'You have to provide original property documents before disbursment',
        variant: 'headerless',
  ...
  handleSubmit(event) {
    ...
    fields.Address_Line_1__c = this.collateralObj.Address_Line_1__c;
    fields.Address_Line_2__c = this.collateralObj.Address_Line_2__c;
    fields.Address_Line_3__c = this.collateralObj.Address_Line_3__c;
    fields.State__c = this.collateralObj.State__c;
    fields.City__c = this.collateralObj.City__c;
    fields.Pincode__c = this.collateralObj.Pincode__c;
    ...
    fields.Collateral_ID__c = this.collateralObj.Collateral_ID__c;
    fields.Apportioned_Loan_Amount__c =
      this.collateralObj.Apportioned_Loan_Amount__c;
    fields.Estimated_market_value__c =
      this.collateralObj.Estimated_market_value__c;
  ...
  delay = (delay) => setTimeout(() => Promise.resolve(), delay);
  async handleSubmitForm() {
    console.log(' === Handle Submit Form ==', this.isLoaded);
    this.collateralObj.Type_Of_Existing_Collateral__c = "Manual";
    this.collateralObj.Collateral_Type__c = "Property";
